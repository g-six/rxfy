...
export async function GET(req: NextRequest) {
  ...
  if (origin && searchParams.get('agent') && mls_id) {
    ...
    const page_url = ['https://sites.leagent.com', searchParams.get('wf') || domain, 'brochure.html'].join('/');
