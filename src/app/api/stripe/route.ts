        ...
        axios
          ...
          .then(({ data }) => {
            try {
              ...
              //   axios.post(`${process.env.NEXT_APP_CMS_GRAPHQL_URL}`,
              //   {
              //     query: gql_create_realtor,
              //     variables: {
              //       data: {
