...
export const FILTERS: Filter[] = [
  ...
  { title: 'Amenities', keys: ['amenities'], types: ['general'] },
  { title: 'Title to Land', keys: ['land_title'], types: ['general'] },
  { title: 'View', keys: ['panoramic_view'], types: ['general'] },
  { title: 'Property Type', keys: ['property_type'], types: ['general'] },
  { title: '# of Fireplaces', keys: ['field_3011', 'total_fireplaces'], types: ['general'] },
  { title: '# of Kitchens', keys: ['field_3237', 'L_KitchensTotal'], types: ['general'] },
  { title: '# of Pets', keys: ['L_PetsTotal'], types: ['general'] },
  { title: 'Rentals Allowed', keys: ['building_by_laws'], types: ['general'] },
  ...
  { title: 'Depth', keys: ['field_3018', 'depth'], types: ['dimensions'] },
  { title: 'Floor Area Total Size', keys: ['floor_area_total'], types: ['dimensions'], behaviors: ['default'] },
  {
    title: 'Floor Area - Unfinished',
    keys: ['field_3128', 'floor_area_unfinished'],
    var: 'area',
    types: ['dimensions'],
  },
  {
    title: 'Floor Area Fin - Abv Main',
    keys: ['lot_area', 'floor_area_upper_floors'],
    var: 'area',
    types: ['dimensions'],
  },
  {
    title: 'Floor Area Fin - Basement',
    keys: ['field_3127', 'floor_area_basement'],
    var: 'area',
    types: ['dimensions'],
  },
  {
  ...
  },
  {
    ...
    keys: ['field_3125', 'floor_area_main'],
    var: 'area',
    types: ['dimensions'],
  },
  ...
  {
    title: 'Construction',
    keys: ['f_3027', 'B_Construction', 'LFD_Construction_41', 'LFD_Construction_72', 'build_features'],
    types: ['construction'],
    behaviors: ['default'],
  },
  {
    title: 'Floor Finish',
    keys: ['f_3032', 'L_Floor_Finish', 'LFD_FloorFinish_103', 'LFD_FloorFinish_50', 'LFD_FloorFinish_19', 'build_features'],
    types: ['construction'],
    behaviors: ['default'],
  },
  { title: 'Driveway Finish', keys: ['DrivewayFinish'], types: ['construction'] },
  {
    ...
    keys: ['f_3028', 'B_Exterior_Finish', 'LFD_ExteriorFinish_42', 'LFD_ExteriorFinish_73', 'build_features'],
    types: ['construction'],
    behaviors: ['default'],
  },
  { title: 'Roughed In Plumbing', keys: ['RoughedInPlumbing'], types: ['construction'] },
  { title: 'Services Connected', keys: ['f_3175', 'B_ServicesConnected', 'connected_services'], types: ['construction'] },
  ...
  {
    title: 'Roof',
    keys: ['f_147', 'B_Roof', 'LFD_Roof_12', 'LFD_Roof_43', 'LFD_Roof_43', 'LFD_Roof_74', 'roofing'],
    types: ['construction'],
    behaviors: ['default'],
  },
